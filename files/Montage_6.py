...
#     commented two lines out December 2024 for remote server operation
#     now selector pops up and does not go away
#      plt.show()
...
#         commented out December 2024 for server operation
#          plt.show()
      
          root.update()
          root.update_idletasks()

#      commented out this if in December 2024 so it will just go away      
#      if selstring[9]==1:
# and indented this destroy so it is not under the if

...
def detect_phen_fastalpha(art_flags1, art_flags2, art_flags3, channel_labels, report_strings):
    O1_index = channel_labels.index('O1')
    o11 = np.sum(art_flags1[O1_index])/1000
    o12 = np.sum(art_flags2[O1_index])/1000
    o13 = np.sum(art_flags3[O1_index])/1000
    score = o13 / o11
    if score > 1.1:
